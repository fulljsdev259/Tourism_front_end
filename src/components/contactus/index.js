        ...
        <div className="container-fluid">
          <div className="row text-center contact-block">
            <div className="col-lg-6 offset-lg-1 col-md-8 offset-md-2 col-sm-10 col-sm-offset-1 contact-div">
              ...
              <div className="desc">
                <div className="info">
                  Lorem ipsum dolor sit amet, enim fabellas vix et. Et eos veri
                  erroribus. Te nobis quaestio neglegentur pro, eam quis
                  temporibus interpretaris te. No veri velit soleat est.
                </div>
                <Formik
                  initialValues={{
                    name: "",
